package web.template.orderBy.db1.codeGenerator;
/**
 * 微信商务助手二维码支付任务表
 */
public class IRobotQrCodePayTaskOrderBy {


		/**
		 * 自增id
		 */
		private boolean irTaskID;

		public void setIrTaskID(boolean irTaskID){
			this.irTaskID=irTaskID;
		}

		public boolean getIrTaskID(){
