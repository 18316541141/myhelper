...
public class IRobotQrCodePayTaskParams {
	...
	private String irHandleState;
	private String irHandleStateLike;
	...
	private String irPushStateLike;
	...
	public String getIrWeiXinHeaderImageLike() {
		return irWeiXinHeaderImageLike;
	}
	...
	public String getIrQrCodeImagePathLike() {
		return irQrCodeImagePathLike;
	}
	public void setIrQrCodeImagePathLike(String irQrCodeImagePathLike) {
		this.irQrCodeImagePathLike = irQrCodeImagePathLike;
	}
	public String getIrHandleState() {
		return irHandleState;
	}
	public void setIrHandleState(String irHandleState) {
		this.irHandleState = irHandleState;
	}
	public String getIrHandleStateLike() {
		return irHandleStateLike;
	}
	public void setIrHandleStateLike(String irHandleStateLike) {
		this.irHandleStateLike = irHandleStateLike;
	}
	public String getIrHandleMessage() {
		return irHandleMessage;
	}
	...
	public String getIrReportPicPathJsonLike() {
		return irReportPicPathJsonLike;
	}
	...
	public String getIrPushState() {
		return irPushState;
	}
	public void setIrPushState(String irPushState) {
		this.irPushState = irPushState;
	}
	public String getIrPushStateLike() {
		return irPushStateLike;
	}
	public void setIrPushStateLike(String irPushStateLike) {
		this.irPushStateLike = irPushStateLike;
	}
