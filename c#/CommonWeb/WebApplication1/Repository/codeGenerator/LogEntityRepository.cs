...
namespace CommonWeb.Repository
{
    ...
    public abstract partial class LogEntityRepository : BaseRepository<LogEntity, LogEntityParams, LogEntitySetNullParams>
    {
        ...
        /// <returns></returns>
        protected override Expression<Func<LogEntity, bool>> BaseValQuery(LogEntityParams paramz, IComparable baseVal, int queryType)
        {
            LogEntityOrderBy orderBy = paramz.orderByAsc;
            if (orderBy != null)
            {
                ...
                if (orderBy.CreateDate)
                {
                    if (queryType == 0)
                    {
                        return a => baseVal.CompareTo(a.CreateDate) > 0;
                    }
                    else if (queryType == 1)
                    {
                        return a => baseVal.CompareTo(a.CreateDate) < 0;
                ...
                if (orderBy.Level)
                {
                    if (queryType == 0)
                    {
                        return a => baseVal.CompareTo(a.Level) > 0;
                    }
                    else if (queryType == 1)
                    {
                        return a => baseVal.CompareTo(a.Level) < 0;
                ...
                if (orderBy.ThreadNo)
                {
                    if (queryType == 0)
                    {
                        return a => baseVal.CompareTo(a.ThreadNo) > 0;
                    }
                    else if (queryType == 1)
                    {
                        return a => baseVal.CompareTo(a.ThreadNo) < 0;
                ...
                if (orderBy.Message)
                {
                    if (queryType == 0)
                    {
                        return a => baseVal.CompareTo(a.Message) > 0;
                    }
                    else if (queryType == 1)
                    {
                        return a => baseVal.CompareTo(a.Message) < 0;
                ...
                if (orderBy.ProjectName)
                {
                    if (queryType == 0)
                    {
                        return a => baseVal.CompareTo(a.ProjectName) > 0;
                    }
                    else if (queryType == 1)
                    {
                        return a => baseVal.CompareTo(a.ProjectName) < 0;
                ...
                if (orderBy.TypeName)
                {
                    if (queryType == 0)
                    {
                        return a => baseVal.CompareTo(a.TypeName) > 0;
                    }
                    else if (queryType == 1)
                    {
                        return a => baseVal.CompareTo(a.TypeName) < 0;
                ...
                if (orderBy.FuncName)
                {
                    if (queryType == 0)
                    {
                        return a => baseVal.CompareTo(a.FuncName) > 0;
                    }
                    else if (queryType == 1)
                    {
                        return a => baseVal.CompareTo(a.FuncName) < 0;
                ...
                if (orderBy.Exception)
                {
                    if (queryType == 0)
                    {
                        return a => baseVal.CompareTo(a.Exception) > 0;
                    }
                    else if (queryType == 1)
                    {
                        return a => baseVal.CompareTo(a.Exception) < 0;
