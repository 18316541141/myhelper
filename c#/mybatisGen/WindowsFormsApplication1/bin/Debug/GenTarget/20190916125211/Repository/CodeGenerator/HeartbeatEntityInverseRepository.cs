...
{
    public sealed partial class HeartbeatEntityInverseRepository : InverseRepository<HeartbeatEntity>
    {
		/// <summary>
		...
		public override void DistributedDeleteInverse(DistributedTransactionPart distributedTransactionPart)
		{
			using (BaseDbContext dbContext = CreateDbContext())
            {
				...
				dbContext.Entry(new HeartbeatEntity{ Id = distributedTransactionPart.TransPrimaryKeyVal }).State = EntityState.Deleted;
