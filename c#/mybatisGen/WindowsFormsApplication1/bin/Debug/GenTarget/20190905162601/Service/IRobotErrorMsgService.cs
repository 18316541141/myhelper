...
----------------------------------------------------------------------------------------------------------------------------
        ...
        public void Update(IRobotErrorMsg data)
        {
            Repository.UpdateChange(new IRobotErrorMsg
            {
                IEErrNo = NextId(),IECreateDate = data.IECreateDate,IEErrOrderNo = data.IEErrOrderNo,IEErrRobotId = data.IEErrRobotId,IEErrPic = data.IEErrPic,IEErrContext = data.IEErrContext,IEHandleStatus = data.IEHandleStatus,
            });
        }
----------------------------------------------------------------------------------------------------------------------------
		/// <summary>
...
----------------------------------------------------------------------------------------------------------------------------
		...
		public int ChangeStatus(List<IRobotErrorMsg> datas)
		{
