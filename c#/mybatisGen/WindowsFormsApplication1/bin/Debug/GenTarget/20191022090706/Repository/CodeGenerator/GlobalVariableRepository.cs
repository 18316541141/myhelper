...
namespace WebApplication1.Repository
{
    ...
    public partial class GlobalVariableRepository : BaseRepository<GlobalVariable,GlobalVariableParams,GlobalVariableSetNullParams>
    {
		/// <summary>
        ...
        IQueryable<GlobalVariable> OrderBy(IQueryable<GlobalVariable> query, GlobalVariableParams eqArgs)
        {
			...
			if (orderBy != null)
            {
							...
							if (orderBy.VarSortIndex) { return query = query.OrderBy(a => a.VarSortIndex); }else 
							if (orderBy.VarName) { return query = query.OrderBy(a => a.VarName); }else 
            ...
            if (orderBy != null)
            {
							...
							if (orderBy.VarSortIndex) { return query = query.OrderByDescending(a => a.VarSortIndex); }else 
							if (orderBy.VarName) { return query = query.OrderByDescending(a => a.VarName); }else 
