...
{
    public sealed partial class GlobalVariableInverseRepository : InverseRepository<GlobalVariable>
    {
		/// <summary>
		...
		public override void DistributedDeleteInverse(DistributedTransactionPart distributedTransactionPart)
		{
			using (BaseDbContext dbContext = CreateDbContext())
            {
				...
				dbContext.Entry(new GlobalVariable{ Id = distributedTransactionPart.TransPrimaryKeyVal }).State = EntityState.Deleted;
